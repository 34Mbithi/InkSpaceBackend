...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URI', 'postgresql://db_7ewv_user:v9Uz0sQWWlysSawYMBMq1nuQD6AffE7T@dpg-cseh2fm8ii6s7393u1m0-a.oregon-postgres.render.com/db_7ewv')
